...
brand/
  ...
  colors/        light + dark mode color tokens
  typography/    type rules + Raleway font files
  logo/          primary, reverse, icon/favicon, and motif (circle/orbit) logo assets
company/
...
- **Accent color:** `#00ACED` (GameDirection blue)
- **Font:** Raleway
- **Logo motif:** circle / orbit
- Full detail: [`brand/guide/brand-guidelines.md`](brand/guide/brand-guidelines.md)
